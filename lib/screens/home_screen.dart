...
class _HomeScreenState extends ConsumerState<HomeScreen>
  ...
  static final _logs = [
    ...
    const LogEntry(
      'WARNING: Firewall detected (Layer 7)',
      LogType.warning,
    ...
    const LogEntry(
      'ERROR: Anomaly detected at node 0x7F',
      LogType.error,
      Duration(milliseconds: 3700),
    ),
    const LogEntry(
      'Recalibrating quantum keys...',
      LogType.normal,
    ...
    const LogEntry(
      'Welcome, Operator. System is yours.',
      LogType.success,
  ...
  void _onMouseMove(PointerEvent e, Size screen) {
    _tilt.value = Offset(
      (screen.width / 2 - e.position.dx) / 25,
      (screen.height / 2 - e.position.dy) / 25,
    );
  }
          ...
          children: [
            ...
            Positioned.fill(
              child: RepaintBoundary(
                child: StarBackground(powerSaveEnabled: powerSaveEnabled),
              ),
            ),
            ...
            const Positioned(
              ...
              left: 0,
              right: 0,
              child: SafeArea(child: HudStatusBar(top: true)),
            ),
            ...
            const Positioned(
              ...
              left: 0,
              right: 0,
              child: SafeArea(child: HudStatusBar(top: false)),
            ),
    ...
    return Column(
      ...
      children: [
          ...
          children: [
            ...
            TextButton(
              onPressed:
                  () => Navigator.of(
                    context,
                  ).pushNamed(AppRoutes.performanceSettings),
              child: Text(
                'SETTINGS',
                style: shareTech(10, color: kPrimary, letterSpacing: 1.8),
              ),
            ),
          ],
        ),
        ...
        Text(
          ...
          style: orbitron(28, weight: FontWeight.w900, letterSpacing: 4),
        ),
        ...
        Text(
          'SYSTEM ID: K-2026-X',
          textAlign: TextAlign.center,
          style: shareTech(11, color: kPrimary.withValues(alpha: 0.45)),
        ),
        ...
        Row(
          ...
          children: [
            _StatusChip('POWER', '100%', kSuccess),
            _StatusChip('SIGNAL', 'LOCKED', kPrimary),
            _StatusChip('THREAT', 'LOW', kWarning),
          ],
        ),
        const SizedBox(height: 28),
                  ...
                  ? Column(
                    ...
                    children: [
                      TerminalPanel(
                        logs: logs,
                        height: 200,
                        onComplete: notifier.onComplete,
                      ),
                      if (hud.complete) ...[
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [
          BoxShadow(color: kPrimary.withValues(alpha: 0.4), blurRadius: 8),
        ],
      ),
    );
  }
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        Text(
          label,
          style: shareTech(10, color: kPrimary.withValues(alpha: 0.5)),
        ),
        const SizedBox(height: 4),
        Container(
